...
.button1:active {
   ...
   background: #1b435e;
                        ...
                        <h1 align="center"><img src="images/Logo/預約.jpg" alt="LOGO" height="150" width="300">   </h1>                         
							<?php if(isset($_SESSION['權限'])&&$_SESSION['權限']==0){?>
                            <a href="addbeautifulsalon
.php" class="button1">新增美容師</a>
						...
						?>
                            ...
                            <?php for ($i=$min; $i<$max ; $i++) {
								 ?>
								<li>
									<a href="rooms.php"><img src="images/designer/<?php echo mysql_result($row,$i,"設計師圖檔");?>" alt="Img"></a>
									<h2><a href="rooms.php"><?php echo mysql_result($row,$i,"設計師名稱");?></a></h2>
                                    
									<p>
										<?php echo mysql_result($row,$i,"設計師自我介紹");?>
									</p>
                                    <style>
                                    .button3 {
...
.button3:active {
   ...
   background: #1b435e;
                                    ...
                                    <span class="button3">
									<?php 
									 $designamount=mysql_result($row,$i,"設計師名額");
									if( $designamount>0)
									{
										if($designamount<2)
									{
										?>
										<a href="reservationpet.php?shopnumber=<?php echo mysql_result($row,$i,"識別碼");?>" class="button3">機會不多</a>
										<?php 
										}
										else
										{
											?>
                                        <a href="reservationpet.php?shopnumber=<?php echo mysql_result($row,$i,"識別碼");?>" class="button3">搶購中</a>
                                        <?php
									...
									else
									{
									 ...
									 echo '<a href="" class="button3">已售罄</a>';	
									}
									?>                                    
                                     </span>
									<span class="rate"><?php echo mysql_result($row,$i,"設計師名額");?> / Day</span>
								</li>
                                <?php  }?>
                                                                                  <style>
/*CSS 分頁php*/ 
...
for($i=1;$i<=$count;$i++) {
if($i == $counts) {
echo'<a href="rooms.php?page='.$i.'" >[' . $i . ']</a>';    //顯示本頁的分頁數字會以[ ]包起來
}            
else if($i == $count) {
echo '<a href="rooms.php?page='.$i.'" >' . $i . '</a>';      //顯示末頁的分頁數字
}
else {
echo '<a href="rooms.php?page='.$i.'">' . $i . ',</a>';    //顯示其他的分頁數字會以" , "作區隔
}        
}  
?>
							</ul>
